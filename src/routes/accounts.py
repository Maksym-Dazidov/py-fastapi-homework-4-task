...
async def register_user(
    ...
    try:
        ...
        activation_link = f"{API_LOCAL_URL}/activate/?email={new_user.email}&token={activation_token.token}"
...
async def activate_account(
    ...
    login_link = f"{API_LOCAL_URL}/accounts/login/"
    background_tasks.add_task(
...
async def request_password_reset_token(
    ...
    reset_link = f"{API_LOCAL_URL}/password-reset/complete/?email={user.email}&token={reset_token.token}"
    background_tasks.add_task(
...
async def reset_password(
    ...
    try:
        ...
        await db.delete(token_record)
        await db.commit()
        login_link = f"{API_LOCAL_URL}/login/"
        background_tasks.add_task(
